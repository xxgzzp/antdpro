...
/** Get a list of all unique categories for orders GET /api/material/contractcategory/ */
export async function apiMaterialContractcategoryList(options?: { [key: string]: any }) {
  return request<{ category?: string }[]>('/api/material/contractcategory/', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function apiMaterialOrdercategoryList(options?: { [key: string]: any }) {
  return request<{ category?: string }[]>('/api/material/ordercategory/', {
    method: 'GET',
    ...(options || {}),
  });
}
